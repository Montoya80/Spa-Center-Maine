...
// Initialize Gemini
// Rule: Use the named parameter and process.env.API_KEY directly.
...
export const generateTreatmentSuggestion = async (
  ...
  // Rule: Use process.env.API_KEY directly as a hard requirement.
  ...
  try {
    ...
    // Rule: Use 'gemini-3-flash-preview' for basic text tasks.
    ...
    // Rule: Property access response.text, not method call response.text().
